    ...
    fetch('/get_calibration_data')
        ...
        .then(data => {
            if (data.status === 'success') {
                const calibrationData = JSON.stringify(data.data, null, 2); // Pretty printd_console_messaged_console_messaged_console_messaged_console_messaged_console_messaged_console_messaged_console_messaged_console_messaged_console_messaged_console_messaged_console_messaged_console_messaged_console_messaged_console_messaged_console_messaged_console_messaged_console_messaged_console_messaged_console_messaged_console_messaged_console_messaged_console_messaged_console_messaged_console_messaged_console_messaged_console_messaged_console_messaged_console_messaged_console_messaged_console_messaged_console_messaged_console_messaged_console_messaged_console_messaged_console_messaged_console_messaged_console_messaged_console_messaged_console_messaged_console_messaged_console_messaged_console_messaged_console_messaged_console_messaged_console_messaged_console_messaged_console_messaged_console_messaged_console_messaged_console_messaged_console_messaged_console_message JSON
